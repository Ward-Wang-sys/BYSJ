...
class VIT_MLA(nn.Module):
    ...
    def forward(self, x):
        ...
        c2 = self.norm_0(outs[self.mla_index[0]])
        c5 = self.norm_1(outs[self.mla_index[1]])
        c8 = self.norm_2(outs[self.mla_index[2]])
        c11 = self.norm_3(outs[self.mla_index[3]])

        p2, p5, p8, p11 = self.mla(c2, c5, c8, c11)
