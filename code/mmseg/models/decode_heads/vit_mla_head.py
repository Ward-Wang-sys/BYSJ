...
class MLAHead(nn.Module):
    ...
    def forward(self, mla_p2, mla_p3, mla_p4, mla_p5):
        ...
        head3 = self.head2(mla_p3)
        head4 = self.head2(mla_p4)
        head5 = self.head2(mla_p5)
...
class VIT_MLAHead(BaseDecodeHead):
    ...
    def __init__(self, img_size=768, mla_channels=256, mlahead_channels=128,num_conv=2,upsampling_method='bilinear',
        ...
        self.conv_2 = nn.Conv2d(512, 256, 1,1)
        self.conv_3 = nn.Conv2d(256, 256, 1, 1)
        self.conv_4 = nn.Conv2d(256, out_channel, 1, 1)
    ...
    def losses(self, seg_logit, seg_label):
        ...
        loss['acc_edge'] = accuracy(se_seg_logit, self._convert_to_edge_labels(seg_label))
        return loss
